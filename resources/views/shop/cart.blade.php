        ...
        <div class="col-12 col-md-10 mx-auto ">
            @if ($cartItems->count() > 0)
                    ...
                    @foreach ($cartItems as $item)
                        ...
                        <div class="row d-flex justify-content-between align-items-center mb-5">
                            ...
                            <div class="col-md-3 col-lg-2 col-xl-2 offset-lg-1">
                                <h5 class="mb-0">{{ $currency_symbol }}{{ number_format(App\Helpers\Helper::currency_converter($item->price), 2) }}</h5>
                            </div>
                ...
                <div class="d-flex justify-content-between align-items-baseline px-4 {{ ($cartItems->count() < 1) ? 'd-none' : '' }}">
                    ...
                    <div class="text-end">
                        <h6 class="text-capitalize">total: {{ $currency_symbol }}{{ number_format(App\Helpers\Helper::currency_converter(\Cart::session(App\Helpers\Helper::getSessionID())->getTotal()), 2) }} </h6>
                        <p>Shipping & taxes calculated at checkout </p>
                        <a href="{{ route('checkout.page-1',session()->get('session')) }}" class="btn btn-dark rounded-0">CHECKOUT</a>
                    </div>
                </div>
            @else
